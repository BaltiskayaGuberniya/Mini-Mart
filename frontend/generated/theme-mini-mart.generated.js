...
import stylesCss from 'themes/mini-mart/styles.css?inline';
...
import vaadinButtonCss from 'themes/mini-mart/components/vaadin-button.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_mini-mart_componentCss']) {
    registerStyles(
      'vaadin-button',
      unsafeCSS(vaadinButtonCss.toString())
    );
    
    document['_vaadintheme_mini-mart_componentCss'] = true;
  }
