...
import com.example.application.views.costumers.CostumersView;
import com.example.application.views.inventory.InventoryView;
...
public class MainLayout extends AppLayout {
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                new MenuItemInfo("Inventory", "la la-columns", InventoryView.class), //

                new MenuItemInfo("Costumers", "la la-columns", CostumersView.class), //

                new MenuItemInfo("About Us", "la la-list", AboutUsView.class), //
